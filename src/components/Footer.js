                ...
                <div className="w-container">
                    <div className="w-row">
                        ...
                        <div className="footer-column w-col w-col-3">
                            ...
                            <div>
                                <a href="https://www.linkedin.com/company/blackbird-lab/" target="_blank" rel="noopener noreferrer"
                                   className="social-link w-inline-block"><img src={LinkedinLogo} alt='Ln'/></a>
                                <a href="https://www.facebook.com/blackbirdlabcompany/" target="_blank" rel="noopener noreferrer"
                                   className="social-link w-inline-block"><img src={FacebookLogo} alt='Fb'/></a>
                                <a href="https://jobs.dou.ua/companies/blackbird-lab/" target="_blank" rel="noopener noreferrer"
